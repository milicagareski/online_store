...
export default function HomeCarousel({ showText }: TextProps) {
  return (
    <section className="container carousel_container">
      {" "}
      <h3 className={{ showText } ? "display_desktop" : "display_mobile"}>
        {" "}
